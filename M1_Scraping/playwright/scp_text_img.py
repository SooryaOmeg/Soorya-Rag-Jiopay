...
# # def scrape_headers(url, save_dir="scraped_data_headers"):
# #     ensure_dir(save_dir)
...
# #         # wait for headers
# #         page.wait_for_selector("button div.css-146c3p1")

# #         # grab all headers
# #         headers = page.locator("button div.css-146c3p1").all_inner_texts()
# #         browser.close()

# #     # save JSON
# #     result = {"headers": headers}
# #     json_path = os.path.join(save_dir, "headers.json")
# #     with open(json_path, "w", encoding="utf-8") as f:
# #         json.dump(result, f, indent=2, ensure_ascii=False)

# #     print(f"✅ Headers saved at {json_path}")
# #     return result


# # if __name__ == "__main__":
# #     url = "https://jiopay.com/business/help-center"  # replace with your target
# #     data = scrape_headers(url)
# #     print(data)
...
# def scrape_all_text_and_images(url, save_dir="scraped_data_general"):
#     ensure_dir(save_dir)
...
#         page.wait_for_selector("div.css-146c3p1, div.css-g5y9jx")
...
#             if src:  # only store valid images
...
#     result = {"url": url, "texts": cleaned_texts, "images": images}
#     json_path = os.path.join(save_dir, f"all_text_and_images_{page}.json")
#     with open(json_path, "w", encoding="utf-8") as f:
#         json.dump(result, f, indent=2, ensure_ascii=False)

#     print(f"✅ Extracted {len(cleaned_texts)} text blocks and {len(images)} images -> saved at {json_path}")
#     return result
...
# ]
#     for u in url:
#         data = scrape_all_text_and_images(u)
#         print(f"Extracted {len(data['texts'])} texts and {len(data['images'])} images")
...
#         # Fallback: clickable divs that may represent PDFs
#         possible_pdf_divs = page.locator("div")
#         for i in range(possible_pdf_divs.count()):
#             el = possible_pdf_divs.nth(i)
#             text = el.inner_text().strip()
#             onclick = el.get_attribute("onclick")
#             href = el.get_attribute("href")

#             # Look for .pdf inside onclick/href
#             candidate = None
